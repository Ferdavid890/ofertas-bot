...
QUERIES_AUCTIONS = ["Lorcana PSA 10"]  # version simple validada
CATEGORY_AUCTIONS = ""  # sin categoria: el texto de la query ya es suficientemente especifico
...
def sync_auctions():
    ...
    try:
        ...
        items, stats = search_engine.ejecutar_motor_general("AUCTION", "endingSoonest", queries=QUERIES_AUCTIONS, category_param=CATEGORY_AUCTIONS, max_items=2000)
