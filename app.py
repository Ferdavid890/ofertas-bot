...
COL_STATUS = 14
# Columna 16 va AL FINAL a proposito (despues de Link): asi los numeros de columna de
# arriba (COL_PRECIO_T60, COL_STATUS, etc.) nunca cambian sin importar si esta columna
# extra existe o no. Es solo una version legible en CDMX de scheduled_closing_time (UTC),
# el codigo la calcula y escribe solo - no hace falta llenarla a mano.
