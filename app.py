...
def iniciar_scheduler():
    ...
    scheduler.add_job(sync_auctions, IntervalTrigger(hours=1), id="sync_auctions")
    scheduler.start()
    recuperar_snipers_pendientes()
    log.info("Scheduler iniciado: listings cada 1h, auctions detectadas cada 1h, snipers puntuales T-60s/T-2s.")
