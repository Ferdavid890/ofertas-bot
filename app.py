...
def revisar_y_actualizar_subastas_pendientes():
    ...
    try:
        ...
        for idx, fila in enumerate(registros[1:], start=2):
            ...
            # CASO 1: Captura a los 60 segundos (si faltan entre 0 y 65 segundos y la columna 60s está vacía o en 0.0)
            ...
            # CASO 2: Captura a los 2 segundos (si faltan entre -2 y 5 segundos)
            if -2 <= segundos_restantes <= 5:
                # Si todavía faltan unos segundos positivos, esperamos con precisión hasta el segundo exacto
